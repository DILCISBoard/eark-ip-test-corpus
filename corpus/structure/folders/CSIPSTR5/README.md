Testcase for structural requirement:
...
Folder "valid" contains valid IPs that check requirement [CSIPSTR5](https://dilcisboard.github.io/E-ARK-CSIP/specification/implementation/structure/#CSIPSTR5)
