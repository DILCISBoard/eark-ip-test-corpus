...
def eark_validator_test_from_test_case(test_case: case.TestCase, path_to_test_case_directory: Path, specification_type: Optional[str]):
    ...
    for rule in test_case.rules.rule:
        for package in rule.corpus_packages.package:
            ...
            output = validate_package_with_eark_validator(path_to_package, version, specification_type)
